...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Редактирование кубка {{$cup->getYearAttribute()}}</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    ...
                    <h2>Редактирование кубка {{$cup->year}} г.</h2>
                    <form action="/cups/{{$cup->id}}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="form-group row">
                            <label for="cup-year" class="col-4 col-form-label">Год проведения:</label>
                            <input id="cup-year"
                                   type="integer"
                        ...
                        <div class="form-group row">
                            <label for="cup-place" class="col-4 col-form-label">Место проведения суперфинала:</label>
                            <input id="cup-place"
                                   type="text"
                                   class="form-control col-8 {{ $errors->has('place') ? ' is-invalid' : '' }}"
                                   name="place"
                                   value="{{old('place') ?? $cup->place}}">
                        ...
                        <div class="form-group row">
                            <label for="cup-country" class="col-4 col-form-label">Страна проведения суперфинала:</label>
                            <input id="cup-country"
                                   type="text"
                                   class="form-control col-8 {{ $errors->has('country') ? ' is-invalid' : '' }}"
                                   name="country"
                                   value="{{old('country') ?? $cup->country}}">
                        ...
                        <div class="form-group row">
                            <label for="cup-winner" class="col-4 col-form-label">Победитель турнира:</label>
                            <input id="cup-winner"
                                   type="text"
                                   class="form-control col-8 {{ $errors->has('winner') ? ' is-invalid' : '' }}"
                                   name="winner"
                                   value="{{old('winner') ?? $cup->winner}}">
                        ...
                        <div class="form-group row">
                            <label for="cup-logo" class="col-4 col-form-label">Логотип победителя:</label>
                            <input id="cup-logo"
                                   type="text"
                                   class="form-control col-8 {{ $errors->has('logo') ? ' is-invalid' : '' }}"
                                   name="logo"
                                   value="{{old('logo') ?? $cup->logo}}">
